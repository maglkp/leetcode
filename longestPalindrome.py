...
def longestPalindrome(s: str) -> str:
    ...
    for i in range(len(s)):
        p1 = expandAroundPivot(i, i, s)
        p2 = expandAroundPivot(i, i + 1, s)
...
def expandAroundPivot(left: int, right: int, s: str) -> int:
    if right > len(s) - 1:
        return 0
    if s[left] != s[right]:
        return 0
...
print(longestPalindrome("abcdc"))
print(longestPalindrome(""))
print(longestPalindrome("a"))
print(longestPalindrome("dvd"))
print(longestPalindrome("abcdvd"))
print(longestPalindrome("abcedvdee"))
